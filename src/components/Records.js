					...
					{props.searchResults.length === 0 ? (
						...
						props.searchResults.map((res) => (
							...
							>
								...
								<div className='flex flex-grow flex-col  py-4 border-b border-gray-200 mb-6 '>
									<p className='text-sm text-gray-400 pb-2  tracking-wider font-mono truncate'>
										{res.year} / {res.country}
									</p>
								...
								<div className='flex flex-row flex-grow-0 flex-auto justify-between space-x-6 w-full'>
									{props.current === "w" ? (
										""
									) : props.collection.includes(res.id) ? (
										<div
										...
										<div
											...
											onClick={() =>
												props.handleAddToCollection(res)
											}
										>
											<svg
												xmlns='http://www.w3.org/2000/svg'
																			...
																			>
																				<td className='px-6 py-4 whitespace-pre-wrap'>
																					...
																					"track" ? (
																						...
																						<div className='text-xs font-extrabold uppercase tracking-wider text-indigo-500'>
																							{
																								track.title
																							}
																						</div>
